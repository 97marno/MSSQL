/* @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	2014-06-10 - Edited so the EXEC command will run with an variable value.
...
--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
SET @newpath_mdf = 'G:\MSSQL10_50.SQLTEST3\MSSQL\DATA\'--@EDIT@ new path where you will put the mdf
SET @newpath_ldf = 'G:\MSSQL10_50.SQLTEST3\MSSQL\DATA\'--@EDIT@ new path where you will put the ldf
SET @path = 'G:\MSSQL10_50.SQLTEST3\MSSQL\Backup\SMITWeb\' --@EDIT@ path where the backup files reside
SET @extension = 'BAK'
