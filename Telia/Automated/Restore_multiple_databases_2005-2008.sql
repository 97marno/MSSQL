...
--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
SET @newpath_mdf = 'I:\MSSQL10_50.SQLTEST5\MSSQL\DATA\'--@EDIT@ new path where you will put the mdf
SET @newpath_ldf = 'I:\MSSQL10_50.SQLTEST5\MSSQL\DATA\'--@EDIT@ new path where you will put the ldf
SET @path = 'I:\MSSQL10_50.SQLTEST5\MSSQL\Backup\Pollux' --@EDIT@ path where the backup files reside
SET @extension = 'BAK'
