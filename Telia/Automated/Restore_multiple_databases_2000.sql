...
--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
SET @newpath_mdf = 'D:\MSSQL.1\MSSQL\Data\'--@EDIT@ new path where you will put the mdf
SET @newpath_ldf = 'D:\MSSQL.1\MSSQL\DATA\'--@EDIT@ new path where you will put the ldf
SET @path = 'D:\MSSQL.1\MSSQL\Backup\marlen\' --@EDIT@ path where the backup files reside
SET @extension = 'BAK'
