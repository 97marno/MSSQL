...
--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
SET @newpath_mdf = 'L:\MSSQL10_50.SQL8\MSSQL\DATA\'--@EDIT@ new path where you will put the mdf
SET @newpath_ldf = 'L:\MSSQL10_50.SQL8\MSSQL\DATA\'--@EDIT@ new path where you will put the ldf
SET @path = 'L:\MSSQL10_50.SQL8\MSSQL\Backup\5280\' --@EDIT@ path where the backup files reside
SET @extension = 'BAK'
